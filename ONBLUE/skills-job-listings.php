...
function skills_job_listings_custom_assets() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'skills_job_listings')) {
        ...
        // Enqueue custom CSS - our base styles + custom header/footer styles
        wp_enqueue_style(
...
// Add shortcode function - now with custom header/footer
...
function skills_job_listings_activate() {
    ...
    // Create the necessary directories for the custom header and footer
