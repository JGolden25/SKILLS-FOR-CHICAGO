...
<footer class="modern-footer">
    <div class="footer-container">
        <div class="footer-top">
            <a href="https://skillsforchicago.org/">
            ...
            <div class="footer-social">
                <a href="https://www.facebook.com/SkillsForChicago/"><i class="fa-brands fa-facebook"></i></a>
                <a href="https://www.linkedin.com/company/skills-for-chicago/?viewAsMember=true"><i class="fa-brands fa-linkedin"></i></a>
                <a href="https://www.youtube.com/@skillsforchicagoland"><i class="fab fa-youtube"></i></a>
                <a href="https://www.instagram.com/skillsforchicago/"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
        ...
        <div class="mobile-footer">
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">ABOUT US</h3>
                ...
                <div class="footer-accordion-content">
                    <ul class="footer-mobile-links">
                        <li><a href="https://skillsforchicago.org/who-we-are/">Who We Are</a></li>
                        <li><a href="https://skillsforchicago.org/our-team/">Our Team</a></li>
                        <li><a href="https://skillsforchicago.org/annual-reports/">Annual Reports & Financials</a></li>
                        <li><a href="https://skillsforchicago.org/our-work/">Our Work in Action</a></li>
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">JOB SEEKERS</h3>
                    <span class="footer-accordion-icon">
                        <i class="fas fa-chevron-down"></i>
                    </span>
                </div>
                <div class="footer-accordion-content">
                    <ul class="footer-mobile-links">
                        <li><a href="https://skillsforchicago.org/find-a-job/">Find A Job</a></li>
                        <li><a href="https://skillsforchicago.org/career-resources/">Career Resources</a></li>
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">EMPLOYERS</h3>
                    <span class="footer-accordion-icon">
                        <i class="fas fa-chevron-down"></i>
                    </span>
                </div>
                <div class="footer-accordion-content">
                    <ul class="footer-mobile-links">
                        ...
                        <li><a href="https://skillsforchicago.org/employer-partners/">Our Employer Partners</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">COMMUNITY PARTNERS</h3>
                    <span class="footer-accordion-icon">
                        <i class="fas fa-chevron-down"></i>
                    </span>
                </div>
                <div class="footer-accordion-content">
                    <ul class="footer-mobile-links">
                        ...
                        <li><a href="https://skillsforchicago.org/community-impact/">Community Impact</a></li>
                        <li><a href="https://skillsforchicago.org/community-partners/">Our Community Partners</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">DONORS</h3>
                    <span class="footer-accordion-icon">
                        <i class="fas fa-chevron-down"></i>
                    </span>
                </div>
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">EVENTS</h3>
                    <span class="footer-accordion-icon">
                        <i class="fas fa-chevron-down"></i>
                    </span>
                </div>
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">NATIONAL EXPANSION</h3>
                    <span class="footer-accordion-icon">
                        <i class="fas fa-chevron-down"></i>
                    </span>
                </div>
                <div class="footer-accordion-content">
                    <ul class="footer-mobile-links">
                        <li><a href="https://skillsforchicago.org/national-expansion/">National Expansion</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer-accordion">
                <div class="footer-accordion-header">
                    <h3 class="footer-accordion-title">CONTACT US</h3>
                    <span class="footer-accordion-icon">
                        <i class="fas fa-chevron-down"></i>
                    </span>
                </div>
                <div class="footer-accordion-content">
                    <ul class="footer-mobile-links">
                        <li><a href="https://skillsforchicago.org/contact-us/">Contact Us</a></li>
                    </ul>
                </div>
            </div>
        </div>
